...
```{r, code =  mydecrypt("11_Week1/task_1.R",".passphrase"), opts.label="solution_hideOutput"}
```
...
```{r code =  mydecrypt("11_Week1/task_2.R",".passphrase"), opts.label="solution_showOutput", fig.cap="Your plot should look something like this."}
```
...
```{r, code =  mydecrypt("11_Week1/task_3.R",".passphrase"), opts.label="solution_hideOutput"}
```
...
```{r, code =  mydecrypt("11_Week1/task_4.R",".passphrase"), opts.label="solution_hideOutput"}
```
...
```{r, code =  mydecrypt("11_Week1/task_5.R",".passphrase"), opts.label="solution_showOutput"}
```
...
```{r code =  mydecrypt("11_Week1/task_6.R",".passphrase"), opts.label="solution_hideOutput"}
```
