...
Git is a software dedicated to version control text files like code scripts. It's heavily used in the software industry as well as in the field of data science. In this course, we will teach use the basic functionalities of Git and combine it with the online portal Github.
